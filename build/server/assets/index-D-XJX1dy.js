...
import { a as useInViewport, c as classes, d as cssProps, n as numToMs, M as ModelAnimationType } from "./server-build-BQufN0BC.js";
...
import { r as removeLights, c as cleanScene, a as cleanRenderer, t as throttle, b as textureLoader, m as modelLoader } from "./three-DKnvalIc.js";
      ...
      gltf.scene.traverse(async (node) => {
        ...
        if (node.name === MeshType.Screen) {
          ...
          loadFullResTexture = async () => {
            const fullSize = texture.src ? await textureLoader.loadAsync(texture.src) : placeholder;
